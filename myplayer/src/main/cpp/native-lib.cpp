...
Java_com_huoshan_myplayer_player_WlPlayer_n_1parpared(JNIEnv *env, jobject instance, jstring source_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_huoshan_myplayer_player_WlPlayer_n_1start(JNIEnv *env, jobject instance) {
    if(fFmpeg != NULL)
    {
